...
const Contact = () => {
    ...
    const eventHandler = (event) =>{
        UpdateFeedBack({...feedBack, [event.target.id] : (event.target.value)});
    }
                        ...
                        <div className="col-md-12 order-md-last d-flex">
                            <form action="#" className="bg-light p-5 contact-form">
                                <div className="form-group">
                                    <input type="text" className="form-control" placeholder="Your Name" id="name" onChange={eventHandler}/>
                                </div>
                                <div className="form-group">
                                    <input type="text" className="form-control" placeholder="Your Email" id="email" onChange={eventHandler}/>
                                </div>
                                <div className="form-group">
                                    <input type="text" className="form-control" placeholder="Subject" id="subject" onChange={eventHandler}/>
                                </div>
                                <div className="form-group">
                                    <textarea name="" id="message" cols="30" rows="7" className="form-control" placeholder="Message" onChange={eventHandler}></textarea>
                                </div>
                                <div className="form-group">
                                    <input type="button" value="Send Message" className="btn btn-primary py-3 px-5" onClick={contactMessage}/>
                                </div>
                            </form>
