...
const Hotel = () => {
    ...
    const eventHandle = (event) =>{
        updateSearchValue({...searchValue, [event.target.id]:(event.target.value)});
    }
                                        ...
                                        <div className="col-lg d-flex">
                                            <div className="form-group p-4 border-0">
                                                ...
                                                <div className="form-field">
                                                    ...
                                                    <input type="text" className="form-control" placeholder="Search place" id="destination" onChange={eventHandle} />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg d-flex">
                                            <div className="form-group p-4">
                                                ...
                                                <div className="form-field">
                                                    ...
                                                    <input type="text" className="form-control checkin_date" placeholder="Check In Date" id="checkindate" onChange={eventHandle} />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg d-flex">
                                            <div className="form-group p-4">
                                                ...
                                                <div className="form-field">
                                                    <div className="icon"><span className="fa fa-calendar"></span></div>
                                                    <input type="text" className="form-control checkout_date" placeholder="Check Out Date" id="checkoutdate" onChange={eventHandle} />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg d-flex">
                                            <div className="form-group p-4">
                                                ...
                                                <div className="form-field">
                                                    <div className="select-wrap">
                                                        ...
                                                        <select name="" id="pricerange" className="form-control" onChange={eventHandle}>
                                        ...
                                        <div className="col-lg d-flex">
                                            <div className="form-group d-flex w-100 border-0">
                                                <div className="form-field w-100 align-items-center d-flex">
                                                    <input type="button" value="Search" className="align-self-stretch form-control btn btn-primary" onClick={SearchFilter} />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
