                    ...
                    <div className="col-md pt-5">
                        <div className="ftco-footer-widget pt-md-5 mb-4">
                            ...
                            <ul className="ftco-footer-social list-unstyled float-md-left float-lft">
                                <li className=""><a href="https://twitter.com/"><span className="fa fa-twitter"></span></a></li>
                                <li className=""><a href="https://facebook.com/"><span className="fa fa-facebook"></span></a></li>
                                <li className=""><a href="https://instagram.com/"><span className="fa fa-instagram"></span></a></li>
                                <li className=""><a href="https://linkedin.com/"><span className="fa fa-linkedin"></span></a></li>
                                <li className=""><a href="https://github.com/"><span className="fa fa-github"></span></a></li>
                            </ul>
                        </div >
                    </div >
